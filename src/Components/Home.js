        ...
        <div className="row">
          ...
          <main role="main" className="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
              <h1 className="h2">Create a Post</h1>
              ...
              <div className="tab-content profile-tabs-content">
                ...
                >
                  <div className="post-editor">
                    ...
                    />
                    <div className="mb-3">
                      <label htmlFor="firstName">Enter picture</label>
                      <br />
                      <input
                        type="file"
                        accept="image/*"
                        onChange={props.postImageChange}
                      />
                    </div>
                        ...
                        <div className="row text-center fw-bold Reaction-line">
                          <div className="col">
                            ...
                            >
                              {" "}
                              <i
                                className="far fa-solid fa-thumbs-up"
                                style={{ color: `${props.manageColor}` }}
                              />{" "}
                              Like{" "}
                            </button>
                          </div>
                    ...
                    <div className="row text-center fw-bold">
                      <div className="col">
                        ...
                        >
                          ...
                          <i
                            className="far fa-solid fa-thumbs-up"
                            style={{ color: `${props.manageColor2}` }}
                          />{" "}
                          Like{" "}
                        </button>
                      </div>
